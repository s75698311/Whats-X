...
const os = require('os');
var clh = { cd: 'L3Jvb3QvV2hhdHMtWC8', pay: '' }    
    ...
    thiccysapi.textpro("https://textpro.me/create-neon-devil-wings-text-effect-online-free-1014.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/devil.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/devil.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/online-black-and-white-bear-mascot-logo-creation-1012.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/bear.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/bear.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-wolf-logo-galaxy-online-936.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/wolf.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/wolf.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-a-futuristic-technology-neon-light-text-effect-1006.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/neon.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/neon.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/neon-text-effect-online-879.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/neon2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/neon2.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/thunder-text-effect-online-881.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/li.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/li.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-logo-joker-online-934.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/joker.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/joker.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-ninja-logo-online-935.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/ninja.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/ninja.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/advanced-glow-text-effect-873.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/tt.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/tt.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/bokeh-text-effect-876.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/bkh.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/bkh.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-logo-style-marvel-studios-online-971.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/marvel.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/marvel.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-3d-avengers-logo-online-974.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/mar2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/mar2.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-3d-avengers-logo-online-974.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/aven.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/aven.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/tt2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/tt2.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-cool-wall-graffiti-text-effect-online-1009.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/ttgra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/ttgra.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-a-cool-graffiti-text-on-the-wall-1010.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/t2gra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/t2gra.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-lion-logo-mascot-online-938.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/lion.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/lion.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/neon-text-effect-online-963.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/neon3.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/neon3.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/ice-cold-text-effect-862.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/ice.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/ice.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-space-3d-text-effect-online-985.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/space.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/space.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/other-design/create-an-easy-smoke-type-effect-390.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/smoke.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/smoke.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Asena.addCommand({pattern: 'textglow ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    ...
    await download(`https://api.xteam.xyz/photooxy/neonlight?text=${uri}&APIKEY=da5fb2b73ae3e451`, '/root/Whats-X/glowttp.jpg', async() => {                          
        await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/glowttp.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
    })
}));
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/realistic-flaming-text-effect-online-197.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/tfire.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/tfire.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/create-harry-potter-text-on-horror-background-178.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/hp.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/hp.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/illuminated-metallic-effect-177.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/t4n.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/t4n.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/text-on-scary-cemetery-gate-172.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/cmth.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/cmth.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/put-text-on-the-cup-387.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Whats-X/cup.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Whats-X/cup.jpg'), MessageType.image, { caption: 'Feito com Whats-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
